...
export const getProductDetailTransformResponse = (product, index = 0) => {
    return {
        id: index,
        ...
        options: {
            id: "option_" + index,
            name: "Size",
            values: [product.productSize || "N/A"],
        },
        images: {
            edges: [
                {
                    node: {
                        id: "image_" + index,
                        originalSrc: product.image || product?.base_image?.original_image_url || null,
                    },
                },
            ],
        },
        ...
        tags: [product.productLabel || "New"],
        collections: {
            edges: [
                {
                    node: {
                        id: "collection_" + index,
                        handle: product.parentCategorySlug || null,
                    },
                },
            ],
        },
